...
then
  ...
  echo "Warning: license agreement method hasn't been passed; see the README (https://github.com/mstackio/image-teamspeak) for how to do so with this Docker image"
